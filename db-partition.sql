...
-- See basic Partitions on a Database
SELECT `TABLE_NAME`, `PARTITION_ORDINAL_POSITION` AS `SN`, `PARTITION_NAME`, `TABLE_ROWS`, `PARTITION_EXPRESSION`
FROM INFORMATION_SCHEMA.`PARTITIONS`
WHERE `PARTITION_NAME` IS NOT NULL AND TABLE_SCHEMA LIKE DATABASE();
